...
<div class="content-wrapper">
  ...
  <section class="content" ng-app="EridenModel" ng-controller="EridenController">
    <div class="row">
	   ...
	   <div class="col-xs-12">
         ...
         <div class="box-header">
            <div class="col-xs-8">
            	<h3 class="box-title">You have created {{ fdData.length }} saving</h3>
            </div>
          ...
          <div id="GridLayout">
          <table width='100%' class="table table-bordered table-hover" id="FDList" ajaxUrl="<?php echo base_url(); ?>eriden/FDListData" deleteUrl="<?php echo base_url(); ?>eriden/FDDelete">
          ...
          <tr ng-repeat="member in resultValue=(fdData | filter:name | orderBy:sortKey:reverse)" id="{{ member.Id }}">	
                ...
                <a class="fa fa-edit" href="javaScript:void(0)" ng-click="FDUpdate('<?php echo base_url(); ?>eriden/FDUpdate/'+member.Id,member.Id)"></a>
                    &nbsp;&nbsp;&nbsp;
                    <a class="fa fa-trash-o" ng-click="DeleteFD(member.Id)" href="javaScript:void(0)"> </a>                    
                </td>
          </tr>
          ...
          <tr>
              ...
              <td colspan="2"><b>&#8377; {{resultValue | totalProfit:'DepositAmount'}}</b></td>
           </tr>
    ...
    <div class='lightbox-content' style="width:70%">
        ...
        <form method="post" id="FDDataPost" action="<?php echo base_url(); ?>eriden/SaveFDData/" redirectUrl="<?php echo base_url(); ?>eriden/FDList" onSubmit="return CreateFD()">
            ...
            <tr>
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                         ...
                         <select  id="PersonName" name='PersonName' class="form-control" required>
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Bank Name" id="BankName" name='BankName' class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Maturity Date" id="MaturityDate" name='MaturityDate' class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Deposit Amount" id="DepositAmount" name='DepositAmount' class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Maturity Amount" id="MaturityAmount" name='MaturityAmount' class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Interest Rate" id="InterestRate" name='InterestRate' class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Account Number" id="AccountNumber" name='AccountNumber' class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        <label for="AssistantPhone">Saving Type <span class='red-star'>*</span></label>
